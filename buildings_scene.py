...
# Buildings
buildings = [
    (3, -2, 1, 1, 6,  (0.8, 0.7, 0.4)),
    (2.5, -2, 0.01, 1, 6,  (0.9, 0.7, 0.1)),

    (5,  1.5, 1, 1.5, 8,  (0.8, 0.2, 0.2)),
    (4.5,  1.5, 0.01, 1.5, 8,  (0.3, 0.7, 0.4)),

    (7,  -4, 2, 1.5, 4, (0.2, 0.4, 0.8)),
    (6,  -4, 0.01, 1.5, 4, (0.9, 0.9, 0.2)),

    (7,  5, 2, 1, 4, (0.4, 0.4, 0.8)),
    (6,  5, 0.01, 1, 4, (0.4, 0.1, 0.4)),

    (8,  -1, 1, 1, 3, (0.8, 0.4, 0.8)),
    (7.5,  -1, 0.01, 1, 3, (0.3, 0.7, 0.8)),

    (10, 2, 1, 1, 5, (0.3, 0.7, 0.4)),
    (9.5, 2, 0.01, 1, 5, (0.2, 0.3, 0.6)),
]
